...
public class GameManager : MonoBehaviour
{
        ...
        if (Physics.Raycast(r, out RaycastHit info, Mathf.Infinity, ~ignoreLayerMask))
        {
            ...
            if (newObject != null)
            {
                ...
                if (selectedRigidbody != null)
                {
                    ...
                    // It's good practice to zero out velocity when making kinematic
                    // to prevent unexpected movement if it's briefly non-kinematic again.
    ...
    public void DeselectObject()
    {
        if (selectedObject != null)
        {
            if (selectedRigidbody != null)
            {
                selectedRigidbody.isKinematic = false; // Just make it non-kinematic
                // NO velocity manipulation here.
            }
